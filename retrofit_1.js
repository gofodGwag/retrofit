...
if (reversed == null) { reversed = false; }
	...
	// Layer_3 copy
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("#FF0000").ss(1,1,1,3,true).p("A7BN2IIn7rIJMAAQQ5RtTXB2");
...
if (reversed == null) { reversed = false; }
	...
	this.shape_141.graphics.f().s("#003E74").ss(2,1,1).p("EAnbANdIABAAQACAAABAAIAEgBIADAAEAnnANcIACAAEAn3ANdIABABIguAiEAnKAM6IArAhADbt/IAiAuAC3tQIAkgvEgn3gNQIAkgvIAiAuEgnFANdIgOAAIAA7cADqNdIgPAAIAA7cAjUNdIABAAQACAAABAAIAFgBIAFAAAi4NdIABABIguAiAjlM6IArAhAjYNdMgjVAAAEAnWANdMgjVAAA");
	this.shape_141.setTransform(278.4,158.475);

	this.shape_142 = new cjs.Shape();
	this.shape_142.graphics.f().s("#000000").ss(2,0,0,4).p("EAnAAABIgEAAEAnEAABQABgBABAAQABAAACAAEAnLAAAIABAAEAnOAAAIAHAAQADAAACAAIACABEgnfAABIAHAAQAEAAAEAAQAEAAAEAAADPABIAIAAQADAAAFAAQADAAAFAAAjuABIgFAAAjqABQABgBABAAQABAAABAAAjgAAIAHAAQACAAADAAIABAB");
